...
p <- ggplot() + 
  ...
  ######## SCORE LABELS ################
annotate("text", x = (triangles_local$x[2]+triangles_local$x[3])/2, y = triangles_local$means[1]+5, label = round(triangles_local$means[1],0), family = "Gotham-Bold", color = "#C65C3D", size = 4.5) +
  annotate("text", x = 0, y = triangles_local$means[4]+5, label = round(triangles_local$means[4],0), family = "Gotham-Bold", color = "#C65C3D", size = 4.5 ) +
  annotate("text", x = (triangles_local$x[8]+triangles_local$x[9])/2, y = triangles_local$means[7]+5, label = round(triangles_local$means[7],0), family = "Gotham-Bold", color = "#C65C3D", size = 4.5 ) +
  
  annotate("text", x = triangles_local$means[10]+5, y = (triangles_local$y[11]+triangles_local$y[12])/2, label = round(triangles_local$means[10],0), family = "Gotham-Bold", color = "#556B59", size = 4.5 ) +
  annotate("text", x = triangles_local$means[13]+5, y = 0, label = round(triangles_local$means[13],0), family = "Gotham-Bold", color = "#556B59", size = 4.5 ) +
  annotate("text", x = triangles_local$means[16]+5, y = (triangles_local$y[17]+triangles_local$y[18])/2, label = round(triangles_local$means[16],0), family = "Gotham-Bold", color = "#556B59", size = 4.5 ) +
  
  annotate("text", x = (triangles_local$x[20]+triangles_local$x[21])/2, y = -triangles_local$means[19]-5, label = round(triangles_local$means[19],0), family = "Gotham-Bold", color = "#4A6B7D", size = 4.5) +
  annotate("text", x = 0, y = -triangles_local$means[22]-5, label = round(triangles_local$means[22],0), family = "Gotham-Bold", color = "#4A6B7D", size = 4.5 ) +
  annotate("text", x = (triangles_local$x[26]+triangles_local$x[27])/2, y = -triangles_local$means[25]-5, label = round(triangles_local$means[25],0), family = "Gotham-Bold", color = "#4A6B7D", size = 4.5 ) +
  
  annotate("text", x = -triangles_local$means[28]-5, y = (triangles_local$y[29]+triangles_local$y[30])/2, label = round(triangles_local$means[28],0), family = "Gotham-Bold", color = "#B17E4A", size = 4.5 ) +
  annotate("text", x = -triangles_local$means[31]-5, y = 0, label = round(triangles_local$means[31],0), family = "Gotham-Bold", color = "#B17E4A", size = 4.5 ) +
  annotate("text", x = -triangles_local$means[34]-5, y = (triangles_local$y[35]+triangles_local$y[36])/2, label = round(triangles_local$means[34],0), family = "Gotham-Bold", color = "#B17E4A", size = 4.5 ) +
  
  #################### QUAD LABELS #####################
  annotate("text", x = 0, y = 115, label = "D   I   R   E   C   T   I   O   N", family = "Gotham-Bold", color = "#edcec4", size = 4.5) +
  annotate("text", x = -115, y = 0, label = "E   N   G   A   G   E   M   E   N   T", angle = 90, family = "Gotham-Bold", color = "#E7D8C8", size = 4.5) +
  annotate("text", x = 0, y = -115, label = "P   E   O   P   L   E", family = "Gotham-Bold", color = "#C8D2D8", size = 4.5) +
  annotate("text", x = 115, y = 0, label = "O   P   E   R   A   T   I   O   N   S", angle = 270, family = "Gotham-Bold", color = "#CCD2CD", size = 4.5) +
  
  ########################### DIMENSION LABELS ################################
annotate("text", x = -105, y = -65.6, label = "F I T", angle = 90, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = -105, y = 0, label = "C U S T O M E R", angle = 90, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = -105, y = 62.6, label = "C L I M A T E", angle = 90, family = "Gotham-Bold", color = "white", size = 3.25) +
  
  annotate("text", x = -65.6, y = 105, label = "V I S I O N", angle = 0, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = 0, y = 105, label = "S T R A T E G Y", angle = 0, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = 62.6, y = 105, label = "L E A D E R S H I P", angle = 0, family = "Gotham-Bold", color = "white", size = 3.25) +
  
  annotate("text", x = 105, y = 65.6, label = "A D A P T A B I L I T Y", angle = 270, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = 105, y = 0, label = "P E R F O R M A N C E", angle = 270, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = 105, y = -62.6, label = "S Y S T E M S", angle = 270, family = "Gotham-Bold", color = "white", size = 3.25) +
  
  annotate("text", x = -65.6, y = -105, label = "D E V E L O P M E N T", angle = 0, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = 0, y = -105, label = "T A L E N T", angle = 0, family = "Gotham-Bold", color = "white", size = 3.25) +
  annotate("text", x = 62.6, y = -105, label = "T E A M W O R K", angle = 0, family = "Gotham-Bold", color = "white", size = 3.25) +
  
  
  ############### QUARTILE LABELS###########################################
  
  annotate("text", x = -23, y = 23, label = "1", angle = 0, family = "Gotham-Bold", color = "BLACK", size = 2.2) +
  annotate("text", x = -48, y = 48, label = "2", angle = 0, family = "Gotham-Bold", color = "BLACK", size = 2.2) +
  annotate("text", x = -73, y = 73, label = "3", angle = 0, family = "Gotham-Bold", color = "BLACK", size = 2.2) +
  annotate("text", x = -98, y = 98, label = "4", angle = 0, family = "Gotham-Bold", color = "BLACK", size = 2.2) +
