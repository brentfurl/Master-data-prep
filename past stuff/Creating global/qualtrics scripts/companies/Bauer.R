...
Bauer2 <- Bauer
 BauerColumns <- c("ResponseID",	"ResponseSet",	"IPAddress",	"StartDate",	"EndDate",	"RecipientLastName",	"RecipientFirstName",	"RecipientEmail",	"ExternalDataReference",	"Finished",	"Status",	"Score-sum",	"Score-weightedAvg",	
  "Score-weightedStdDev",	"Vision & Values-sum",	"Vision & Values-weightedAvg",	"Vision & Values-weightedStdDev",	"Strategy-sum",	"Strategy-weightedAvg",	"Strategy-weightedStdDev",	"Leadership-sum",	
  "Leadership-weightedAvg",	"Leadership-weightedStdDev",	"Adaptability-sum",	"Adaptability-weightedAvg",	"Adaptability-weightedStdDev",	"Performance Management-sum",	"Performance Management-weightedAvg",	
  "Performance Management-weightedStdDev",	"Systems & Processes-sum",	"Systems & Processes-weightedAvg",	"Systems & Processes-weightedStdDev",	"Coaching & Development-sum",	"Coaching & Development-weightedAvg",	
  "Coaching & Development-weightedStdDev",	"Talent Management-sum",	"Talent Management-weightedAvg",	"Talent Management-weightedStdDev",	"Team Capabilities-sum",	"Team Capabilities-weightedAvg",	
  "Team Capabilities-weightedStdDev",	"Employee Clarity & Fit-sum",	"Employee Clarity & Fit-weightedAvg",	"Employee Clarity & Fit-weightedStdDev",	"Customer Focus-sum",	"Customer Focus-weightedAvg",	
  "Customer Focus-weightedStdDev",	"Communication Effectiveness-sum",	"Communication Effectiveness-weightedAvg",	"Communication Effectiveness-weightedStdDev",	"Direction-sum",	"Direction-weightedAvg",	
  "Direction-weightedStdDev",	"Operations-sum",	"Operations-weightedAvg",	"Operations-weightedStdDev",	"People-sum",	"People-weightedAvg",	"People-weightedStdDev",	"Engagement-sum",	"Engagement-weightedAvg",	
  "Engagement-weightedStdDev",	"Company",	"Industry",	"Q1",	"Role",	"Tenure",	"Generation",	"Gender",	"Characteristics_1_TEXT",	"Characteristics_2_TEXT",	"Characteristics_3_TEXT",	"Characteristics_4_TEXT",	"Characteristics_5_TEXT",	
  ...
  "positivity_1",	"positivity_2",	"positivity_3",	"positivity_4",	"positivity_5",	"satisfaction_1",	"effort_2",	"RO-BR-FL_12",	"DO-Q-Direction",	"DO-Q-Operations",	"DO-Q-People",	"DO-Q-Engagement",	"LocationLatitude",	"LocationLongitude", 
  "LocationAccuracy", "All", "CPI")



Bauer <- add_column(Bauer, All = "All")
Bauer <- add_column(Bauer, CPI = "new")
Bauer$Company <- "Bauer"
colnames(Bauer) <- BauerColumns
## 1.  select vars
...
Bauer <- Bauer %>% select(ResponseID, Company, CPI, StartDate,EndDate, cpi_vv_1:effort_2,nps, Tenure, Generation, Gender, All, Role)
...
Bauer <- Bauer %>% mutate(cpi_adapt_1 = recode(cpi_adapt_1, "Strongly Disagree" = "Strongly Agree",
                                                 "Disagree" = "Agree",
...
## FILTER MISSING DATA
Bauer <- filter(Bauer, Positivity >= 0)

saveRDS(Bauer, paste0(file,"Cleaned/Bauer.rds"))
write_csv(Bauer, paste0(file,"Cleaned/Bauer.csv"))
